...
<p align="left">
  ...
  4. Start the Json Server by running "json:server”:”json-server — watch db.json"
</p>
<h3 align="left">Usage:</h3>
<p align="left">
  1. The fake REST API will be available at http://localhost:3000.
  2. Use this API to perform CRUD operations on player profiles.
</p>
<h3 align="left">JSON Server Configuration:</h3>
<p align="left">
  1. The configuration for the fake REST API is stored in db.json.
  2. Customize this file to add, modify, or remove data as needed
</p>
